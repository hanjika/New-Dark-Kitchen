...
if (themeBtn) themeBtn.addEventListener("click", ()=>{
    _darkmode.darkThemeActivateButtonsAndLinks(themeBtn);
});
...
for (let course of courses){
    ...
    if (course === "All") image.setAttribute("src", require("../Images/All.png"));
    else if (course === "Pizza") image.setAttribute("src", require("../Images/Pizza.png"));
    else if (course === "Pasta") image.setAttribute("src", require("../Images/Pasta.png"));
    else if (course === "Desserts") image.setAttribute("src", require("../Images/Desserts.png"));
...
for (let dish of _menuDefault.default){
    ...
    if (dish.type === "Pizza") document.getElementsByClassName("PizzaSection")[0].appendChild(dishArticle);
    else if (dish.type === "Pasta") document.getElementsByClassName("PastaSection")[0].appendChild(dishArticle);
    else if (dish.type === "Desserts") document.getElementsByClassName("DessertsSection")[0].appendChild(dishArticle);
}
...
for (let filter of filters){
    ...
    const image = document.createElement("img");
    if (filter === "Vegetarian") image.setAttribute("src", require("../Images/Vegetarian.png"));
    else if (filter === "Spicy") image.setAttribute("src", require("../Images/Spicy.png"));
    else if (filter === "Comfort") image.setAttribute("src", require("../Images/Comfort.png"));
...
for (let button of clearAll)if (button) button.addEventListener("click", (e)=>{
...
},{"./menu":"lGdvw","./displaysections":"lSbEP","./shoppingcart":"ea2QH","./darkmode":"iQ8mk","../Images/All.png":"fNMyi","../Images/Pizza.png":"bp3ta","../Images/Pasta.png":"iXP9S","../Images/Desserts.png":"cbUVx","../Images/Vegetarian.png":"jHClV","../Images/Spicy.png":"c8Zdd","../Images/Comfort.png":"hMsfN","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"lGdvw":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
const MENU = [
    {
        ...
        price: 9,
        image: require("../Images/sarda.jpeg"),
        quantity: 1
    },
    {
        type: "Pizza",
        ...
        price: 9,
        image: require("../Images/Pizza-Romana-1-800x477.jpeg"),
        quantity: 1
    },
    {
        type: "Pizza",
        ...
        price: 8,
        image: require("../Images/napoletana.jpeg"),
        quantity: 1
    },
    {
        type: "Pizza",
        ...
        price: 11,
        image: require("../Images/four-seasons-pizza.jpeg"),
        quantity: 1
    },
    {
        type: "Pasta",
        ...
        price: 8,
        image: require("../Images/pasta-carbonara_b-864x413.jpeg"),
        quantity: 1
    },
    {
        type: "Pasta",
        ...
        price: 8,
        image: require("../Images/bolognaise.jpeg"),
        quantity: 1
    },
    {
        type: "Pasta",
        ...
        price: 10,
        image: require("../Images/lasagna-bolognese.jpeg"),
        quantity: 1
    },
    {
        type: "Pasta",
        ...
        price: 9,
        image: require("../Images/Spaghetti-Cacio-e-Pepe-Pecorino-and-black-pepper-spaghetti_1200x800.jpeg"),
        quantity: 1
    },
    {
        type: "Desserts",
        ...
        price: 4,
        image: require("../Images/Torrone Semifreddo.jpeg"),
        quantity: 1
    },
    {
        type: "Desserts",
        ...
        price: 10,
        image: require("../Images/pannacotta.jpeg"),
        quantity: 1
    },
    {
        type: "Desserts",
        ...
        price: 9,
        image: require("../Images/biscotti.jpeg"),
        quantity: 1
    }, 
];
exports.default = MENU;

},{"../Images/sarda.jpeg":"88TQ8","../Images/Pizza-Romana-1-800x477.jpeg":"2NA9U","../Images/napoletana.jpeg":"7FzD3","../Images/four-seasons-pizza.jpeg":"47DcE","../Images/pasta-carbonara_b-864x413.jpeg":"4TdBE","../Images/bolognaise.jpeg":"1NKbw","../Images/lasagna-bolognese.jpeg":"hIPQA","../Images/Spaghetti-Cacio-e-Pepe-Pecorino-and-black-pepper-spaghetti_1200x800.jpeg":"amUK4","../Images/Torrone Semifreddo.jpeg":"fREC5","../Images/pannacotta.jpeg":"47UbH","../Images/biscotti.jpeg":"wzvaQ","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"88TQ8":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('fqHw8') + "sarda.d4d3b0d4.jpeg";
...
},{}],"2NA9U":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('fqHw8') + "Pizza-Romana-1-800x477.078e28a0.jpeg";

},{"./helpers/bundle-url":"8YnfL"}],"7FzD3":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('fqHw8') + "napoletana.92ef1578.jpeg";

},{"./helpers/bundle-url":"8YnfL"}],"47DcE":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('fqHw8') + "four-seasons-pizza.c3024e73.jpeg";

},{"./helpers/bundle-url":"8YnfL"}],"4TdBE":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('fqHw8') + "pasta-carbonara_b-864x413.a616f99c.jpeg";

},{"./helpers/bundle-url":"8YnfL"}],"1NKbw":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('fqHw8') + "bolognaise.4ba4b4b9.jpeg";

},{"./helpers/bundle-url":"8YnfL"}],"hIPQA":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('fqHw8') + "lasagna-bolognese.1af295ba.jpeg";

},{"./helpers/bundle-url":"8YnfL"}],"amUK4":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('fqHw8') + "Spaghetti-Cacio-e-Pepe-Pecorino-and-black-pepper-spaghetti_1200x800.5cedab94.jpeg";

},{"./helpers/bundle-url":"8YnfL"}],"fREC5":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('fqHw8') + "Torrone Semifreddo.4138ec6e.jpeg";

},{"./helpers/bundle-url":"8YnfL"}],"47UbH":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('fqHw8') + "pannacotta.c4893518.jpeg";

},{"./helpers/bundle-url":"8YnfL"}],"wzvaQ":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('fqHw8') + "biscotti.e33fbec2.jpeg";
...
function displayCourseSection(e) {
    ...
    if (e.target.classList.contains("active")) for (article of articles){
    ...
    else for (article of articles){
        let articleParent = article.parentNode;
        if (articleParent.classList.contains(type + "Section")) article.style.display = "none";
    }
...
function displayFilteredDishes(e) {
    ...
    if (e.target.classList.contains("active")) for (article of articles){
        ...
        const filters = document.querySelectorAll("li a");
        if (filters[4].classList.contains("inactive") && filters[5].classList.contains("inactive") && filters[6].classList.contains("inactive")) for (article of articles){
            let articleParent = article.parentNode;
            if (articleParent.classList.contains("active")) article.style.display = "flex";
        }
    }
    _noresults.displayNoResults();
}
...
function deactivateSiblingSectionsOfParent(section) {
    const allUnselectedParents = _getsiblings.getSiblings(section.parentNode);
    for (let unselectedParent of allUnselectedParents)if (unselectedParent.firstChild.classList.contains("active")) deactivateSection(unselectedParent.firstChild);
}
function removeActiveClassFromUnselectedSiblings(selectedElement) {
    ...
    for (let notSelected of allNotSelected)if (notSelected.classList.contains("active")) notSelected.classList.remove("active");
}
...
function activateOrDeactivateAdditionalFilters(e) {
    ...
    if (e.target.classList.contains("inactive")) {
        activateSection(e.target);
        for (let select of selected)if (select.classList.contains("food")) select.classList.add("active");
    } else if (e.target.classList.contains("active")) {
        deactivateSection(e.target);
        for (let select of selected)if (select.classList.contains("food")) select.classList.remove("active");
    }
    let arr = [
        "Vegetarian",
        "Spicy",
    ...
    for (let unselectedType of arrWithoutSelectedType){
        ...
        for (let article of articles)if (article.classList.contains(unselectedType)) article.classList.toggle("active");
    }
    deactivateSiblingSectionsOfParent(e.target);
}
...
function removeMatchingMessages(message) {
    ...
    for (let info of paragraphs)if (info.innerHTML === message) info.parentNode.removeChild(info);
}
function displayNoResults() {
    ...
    const articles = document.querySelectorAll(".food");
    let yes = 0;
    for (let article of articles)if (article.style.display !== "none") yes++;
    if (yes === 0) {
...
function darkThemeActivateButtonsAndLinks(themeBtn) {
    const allBtn = document.querySelectorAll("button");
    const allBtnLi = document.querySelectorAll("a");
    for (let btn of allBtn)btn.classList.toggle("darkTheme");
    for (let btnLi of allBtnLi)btnLi.classList.toggle("darkTheme");
...
},{"../Images/LogoNoir-removebg-preview.png":"1UUfI","../Images/logo.png":"bKfFE","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"1UUfI":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('fqHw8') + "LogoNoir-removebg-preview.c5017728.png";

},{"./helpers/bundle-url":"8YnfL"}],"bKfFE":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('fqHw8') + "logo.8a601a96.png";

},{"./helpers/bundle-url":"8YnfL"}],"fNMyi":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('fqHw8') + "All.0baba561.png";

},{"./helpers/bundle-url":"8YnfL"}],"bp3ta":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('fqHw8') + "Pizza.b3962de0.png";

},{"./helpers/bundle-url":"8YnfL"}],"iXP9S":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('fqHw8') + "Pasta.264028e5.png";

},{"./helpers/bundle-url":"8YnfL"}],"cbUVx":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('fqHw8') + "Desserts.f021359a.png";

},{"./helpers/bundle-url":"8YnfL"}],"jHClV":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('fqHw8') + "Vegetarian.7a9bffef.png";

},{"./helpers/bundle-url":"8YnfL"}],"c8Zdd":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('fqHw8') + "Spicy.f52700dd.png";

},{"./helpers/bundle-url":"8YnfL"}],"hMsfN":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('fqHw8') + "Comfort.a0788792.png";

},{"./helpers/bundle-url":"8YnfL"}]},["hkXzs","23obh"], "23obh", "parcelRequire0daf")
